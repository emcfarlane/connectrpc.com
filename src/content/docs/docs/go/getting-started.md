...
description: "Build a Connect service in Go in fifteen minutes — define a Protobuf schema, generate code, implement handlers, and call your API."
---
...
$ go get -tool connectrpc.com/connect/v2/cmd/protoc-gen-connect-go@latest
```
...
&mdash; `greet.connect.go` is just under 100 lines of code, including comments.
...
```shellsession
$ go get connectrpc.com/connect/v2
...
the `WithGRPC` or `WithGRPCWeb` transport options.
